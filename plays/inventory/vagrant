...
# From https://github.com/ansible/ansible/blob/3f9879aedbdb71479aac193edb89d7a4b996b1a8/contrib/inventory/vagrant.py
...
# List out server names that match the given pattern
def group_by(hosts, pattern):
    list = []
    for host in hosts:
